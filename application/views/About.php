												...
												<table class="table table-striped table-bordered jambo_table bulk_action" id="tb_ajuan" style="width:100%">
													<thead>
														<tr>
															<th>
																<p>
																	e-Document atau (electronic document), adalah aplikasi berbasis web untuk pengelolaan 
																	dokumen secara berkala dari unit kerja prodi/LPPM/LPM/bidang  atau bagian dengan memanfaatkan teknologi informasi, sehingga dalam proses penyimpanan dokumen bisa terukur dan dinilai dari berbagai aspek,
																</p>
																<h4>Tujuan</h4>
																<ul>
																	<li>Efektivitas dan efisiensi dalam  penyimpanan document penting khususnya dilingkungan kampus Politeknik Piksi Ganesha</li>
																	<li>Integrasi sistem  Dokumen untuk mencapai manajemen arsip yang baik</li>
																	<li>Kemudahan dalam proses Monitoring semua jenis document </li>
